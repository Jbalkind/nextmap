...
def generate_designs():
    ...
    if need_generation:
        ...
        # Add yosys to PATH if needed
        yosys_paths = ["/home/jbalkind/tools/yosys", "/home/jbalkind/Documents/tools/yosys"]
        for yosys_path in yosys_paths:
            if os.path.exists(yosys_path) and yosys_path not in os.environ.get('PATH', ''):
                os.environ['PATH'] = f"{yosys_path}:{os.environ.get('PATH', '')}"
                break
