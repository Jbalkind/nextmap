...
def run_with_lut_mapping(benchmark_path: str, lut_count: int, greedy: bool = True):
    ...
    with contextlib.redirect_stdout(f):
        ...
        emap.rewrites.techmap_luts(netlist, k=6, cnt=lut_count, rseed=42, greedy=greedy)
...
def main():
    ...
    benchmarks = [
        ('eval/out/fir_n16_w8.json', 50, 'FIR n=16 w=8'),
        ('eval/out/fir_n16_w8.json', 100, 'FIR n=16 w=8 (100 LUTs)'),
    ]
