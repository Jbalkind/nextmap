    ...
    for run in range(runs):
        ...
        try:
            ...
            while cnt > 0:
                ...
                cnt += nextmap.rewrites.apply_dff_forward_aby_cell(netlist, dff_forward_matches)
                cnt += nextmap.rewrites.apply_dff_backward_aby_cell(netlist, dff_backward_matches)
                total_rewrites += cnt
...
def main():
    ...
    # Run from the repository root (this file lives in eval/scripts/).
