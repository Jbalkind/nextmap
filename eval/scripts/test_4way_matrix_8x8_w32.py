...
def patch_postgres_queries():
    """Patch nextmap's PostgreSQL query execution to handle reserved column names"""
    import nextmap.db_postgres
    import nextmap.db_interface

    # Save original execute methods for all possible paths
    original_adapter_execute = nextmap.db_postgres.PostgreSQLAdapter.execute
    original_netlistdb_execute = nextmap.db_postgres.NetlistDB.execute
    original_interface_execute = nextmap.db_interface.NetlistDB.execute
    ...
    nextmap.db_postgres.PostgreSQLAdapter.execute = patched_adapter_execute
    nextmap.db_postgres.NetlistDB.execute = patched_netlistdb_execute
    nextmap.db_interface.NetlistDB.execute = patched_interface_execute
