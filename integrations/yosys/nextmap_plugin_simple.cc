...
struct NextmapPass : public Pass {
    ...
    void help() override
    {
        ...
        log("        (default: schema shipped with the installed nextmap package)\n");
        log("\n");
        log("    -iterations <n>\n");
    ...
    void execute(std::vector<std::string> args, RTLIL::Design *design) override
    {
        ...
        // Empty by default: nextmap_runner.py resolves the schema shipped with
        // the installed nextmap package.
